...
<head>
    ...
    <!-- End layout styles -->
    <link rel="stylesheet" href="{{asset('assets/images/its.png')}}">
    <!-- <link rel="shortcut icon" href="assets/images/its.png" /> -->
</head>
<body>
<div class="container-scroller">
    ...
    <nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
            ...
            <a class="navbar-brand brand-logo" href="db.php"><img src="{{asset('assets/images/logo.png')}}" alt="logo" /></a>
            <a class="navbar-brand brand-logo-mini" href="db.php"><img src="{{asset('assets/images/logo-mini.png')}}" alt="logo" /></a>
            </div>
...
<script src="{{asset('assets/vendors/js/vendor.bundle.base.js')}}"></script>
  ...
  var data = {
    ...
    foreach ($data as $row) {
      # code...
      echo json_encode($row->created_at->format('d-m-y H:i:s')).',';
    }?>
      ],
    datasets: [{
      label: '# of Votes',
